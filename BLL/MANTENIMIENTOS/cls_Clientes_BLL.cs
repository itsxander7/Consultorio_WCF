...
namespace BLL.MANTENIMIENTOS
{
    public class cls_Clientes_BLL
    {
        ...
        //GUARDAR Y ACTUALIZAR --- FALTA TERMINAR DE ARREGLAR
        public void Guardar_CLIENTES(ref cls_Clientes_DAL Obj_Clientes_DAL)
        {
            ...
            Obj_Clientes_DAL.DtParametros.Rows.Add("@id_cliente", "1", Obj_Clientes_DAL.ID_CLIENTE);
            Obj_Clientes_DAL.DtParametros.Rows.Add("@nombre_cliente", "2", Obj_Clientes_DAL.NOMBRE_CLIENTE);
            Obj_Clientes_DAL.DtParametros.Rows.Add("@apellido1_cliente", "3", Obj_Clientes_DAL.APELLIDO1_CLIENTE);
            Obj_Clientes_DAL.DtParametros.Rows.Add("@apellido2_cliente", "4", Obj_Clientes_DAL.APELLIDO2_CLIENTE);
            Obj_Clientes_DAL.DtParametros.Rows.Add("@direccion_cliente", "5", Obj_Clientes_DAL.DIRECCION_CLIENTE);
            Obj_Clientes_DAL.DtParametros.Rows.Add("@telefono_cliente", "6", Obj_Clientes_DAL.TELEFONO);
            Obj_Clientes_DAL.DtParametros.Rows.Add("@correo_cliente", "7", Obj_Clientes_DAL.CORREO_CLIENTE);
